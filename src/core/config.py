...
class Settings(BaseSettings):
    ...
    AI_OPENROUTER_URL: str = Field(
        ...
        env='AI_OPENROUTER_URL'
    )
    AI_OPENROUTER_API_KEY: str = Field('', env='AI_OPENROUTER_API_KEY')
    AI_OPENROUTER_TIMEOUT: int = Field(60, env='AI_OPENROUTER_TIMEOUT')
    AI_OPENROUTER_MAX_TOKENS: int = Field(
        1000, env='AI_OPENROUTER_MAX_TOKENS'
    )
    AI_OPENROUTER_TEMPERATURE: float = Field(
        0.7, env='AI_OPENROUTER_TEMPERATURE'
    )
